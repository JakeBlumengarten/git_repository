...
chicagoypw <- ggplot(chicago_bears_24, aes(x = week)) +
...
```{r}
ypg_winpct <- ggplot(yards_pg_pt, aes(x=avgyards, y= winpct))+
  geom_point()+
...
```{r}
qbs_bar <- ggplot(top_qbs, aes(x= avg_yards, y= passer_player_id))+
